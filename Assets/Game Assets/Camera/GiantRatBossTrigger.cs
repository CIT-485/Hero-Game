...
public class GiantRatBossTrigger : MonoBehaviour
{
    ...
    IEnumerator Cinematic()
    {
        ...
        player.GetComponent<PlayerMovement>().m_body2d.velocity = Vector3.zero;
        player.GetComponent<PlayerMovement>().actionAllowed = false;
        ...
        player.GetComponent<PlayerMovement>().actionAllowed = true;
